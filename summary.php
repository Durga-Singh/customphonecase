...
<body>
    ...
    if (selectedModel && modelHeading) {
        ...
        const modelText = selectedModel === 'iphoneX' ? 'iPhone 12 pro' : 'iPhone 12'; // Correcting model name
    ...
    if (selectedMaterial && materialPriceItem) {
        const materialText = selectedMaterial === 'silicone' ? 'Silicone material' : 'Soft polycarbonate material';
    ...
    if (selectedFinish && finishPriceItem) {
        const finishText = selectedFinish === 'glossy' ? 'Glossy finish' : 'Matte finish';
